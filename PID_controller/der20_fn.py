...
def der_fn(x, t, disturbance_R, disturbance_L):
    ...
    if t <= 0.4:
        ...
        Qratio = np.array([[nq1 * x[3]], [nq2 * x[8]], [nq3 * x[13]], [nq4 * x[18]], [nq5 * x[23]],
                           [nq6 * x[28]], [nq7 * x[38]], [nq8 * x[43]], [nq9 * x[48]], [nq10 * x[53]],
                           [nq11 * x[58]], [nq12 * x[63]], [nq13 * x[68]], [nq14 * x[73]], [nq15 * x[78]],
                           [nq16 * x[83]], [nq17 * x[88]], [nq18 * x[93]], [nq19 * x[98]], [nq20 * x[103]]])
        ...
        V_array = np.array(
            [[x[181] - Qratio[0][0]], [x[182] - Qratio[1][0]], [x[183] - Qratio[2][0]], [x[184] - Qratio[3][0]],
             [x[185] - Qratio[4][0]], [x[186] - Qratio[5][0]], [x[187] - Qratio[6][0]], [x[188] - Qratio[7][0]],
             [x[189] - Qratio[8][0]], [x[190] - Qratio[9][0]], [x[191] - Qratio[10][0]], [x[192] - Qratio[11][0]],
             [x[193] - Qratio[12][0]], [x[194] - Qratio[13][0]], [x[195] - Qratio[14][0]], [x[196] - Qratio[15][0]],
             [x[197] - Qratio[16][0]], [x[198] - Qratio[17][0]], [x[199] - Qratio[18][0]], [x[200] - Qratio[19][0]]])
        ...
        Vol_Mat = -1 * a_ctrl * (
                np.dot(L + G, V_array - np.array([[Vnom], [Vnom], [Vnom], [Vnom],
                                                  [Vnom], [Vnom], [Vnom], [Vnom],
                                                  [Vnom], [Vnom], [Vnom], [Vnom],
                                                  [Vnom], [Vnom], [Vnom], [Vnom],
                                                  [Vnom], [Vnom], [Vnom], [Vnom]])) + np.dot(L, Qratio))
        # ---frequency input---
        ...
        xdot189 = Vol_Mat[8][0]
        xdot190 = Vol_Mat[9][0]
        xdot191 = Vol_Mat[10][0]
        xdot192 = Vol_Mat[11][0]
        xdot193 = Vol_Mat[12][0]
        xdot194 = Vol_Mat[13][0]
        xdot195 = Vol_Mat[14][0]
        xdot196 = Vol_Mat[15][0]
        xdot197 = Vol_Mat[16][0]
        xdot198 = Vol_Mat[17][0]
        xdot199 = Vol_Mat[18][0]
        xdot200 = Vol_Mat[19][0]
...
def main(i, args, states, sampling_time=0.1, plotting=True, is_disturbance=True, random_seed=0):
...
if __name__ == '__main__':
    ...
    for i in range(len(test_seeds)):
        reward, state = main(i, args, states, sampling_time, plotting=True, is_disturbance=False,
                             random_seed=test_seeds[i])  # False True
